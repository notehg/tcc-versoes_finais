...
<form method="POST" action="" class="alexandre">
    ...
    <div class="estrelas">
    <label for="estrela_um" class="star-label"></label>
<input type="radio" id="estrela_um" name="estrela" value="1">
        
<label for="estrela_dois" class="star-label"></label>
<input type="radio" id="estrela_dois" name="estrela" value="2">
        
<label for="estrela_tres" class="star-label"></label>
<input type="radio" id="estrela_tres" name="estrela" value="3">
        
<label for="estrela_quatro" class="star-label"></label>
<input type="radio" id="estrela_quatro" name="estrela" value="4">
        
<label for="estrela_cinco" class="star-label"></label>
