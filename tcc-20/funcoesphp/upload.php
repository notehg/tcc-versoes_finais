            ...
            if (isset($_FILES["imageFile"]) && $_FILES["imageFile"]["error"] === UPLOAD_ERR_OK) {
                ...
                if (in_array($imageFileType, array("jpg", "jpeg", "png", "gif"))) {
                    if (move_uploaded_file($_FILES["imageFile"]["tmp_name"], $imageTargetFile)) {
                        ...
                        $sql = "INSERT INTO files (title, genre, pdf_filename, image_filename, sinopse) VALUES ('$title', '$genre', '$pdfFilename', '$imageFilename', '$sinopse')";
                ...
                // Insere os dados na tabela
                $sql = "INSERT INTO files (title, genre, pdf_filename, sinopse) VALUES ('$title', '$genre', '$pdfFilename', '$sinopse')";
                if (mysqli_query($conn, $sql)) {
