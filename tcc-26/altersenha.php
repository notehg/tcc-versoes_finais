...
<div class="main-login">
    <div class="left-login" >
            <h1> Alterar senha</h1>
            <p>Compreendemos que às vezes pode acontecer de esquecermos nossas senhas ou enfrentarmos desafios para acessar nossas contas. Não se preocupe, estamos aqui para facilitar o processo de recuperação de senha, garantindo sua segurança e privacidade.</p>
